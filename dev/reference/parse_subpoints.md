...
- **"Clarification statement:" segments** (Cyber.org K-12 and CSTA
  ...
  [cybed:Example](https://ryanstraight.github.io/cybedtools/dev/reference/build_example_node.md)
  nodes by
...
- **"such as / including / examples of ..." patterns** (NICE, SFIA,
  ...
  [cybed:Subpoint](https://ryanstraight.github.io/cybedtools/dev/reference/build_subpoint_node.md)
  nodes.
