...
<img src="assets/branding/concordance-wordmark-paper.svg" class="license-wordmark" alt="Concordance">
</div>
...
Prose, headings, captions, persona scenarios, query interpretations, and other written content on this site are licensed under the [Creative Commons Attribution 4.0 International License (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/).
...
The R scripts, Quarto configurations, SCSS, JavaScript, and SVG assets that build this site are licensed under the [MIT License](https://opensource.org/license/MIT), matching the cybedtools R package this site documents.
...
To run the underlying queries against full framework text, install the [cybedtools R package](https://github.com/ryanstraight/cybedtools) and stage the framework source data per `docs/framework-data-sources.md`.
