...
- **`cybed:Role`**: the framework's top-level organizing unit (work role, role profile, skill, grade-band concept cluster, knowledge area).
- **`cybed:RoleElement`**: the codable atomic statement attached to a Role (task, knowledge statement, skill statement, standard, learning outcome).

A single SPARQL query targeting `cybed:RoleElement` returns elements across every framework in one pass.
