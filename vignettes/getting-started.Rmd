...
- **`cybed:OrganizingUnit`**: the framework's top-level enumerated unit (work role, work profile, skill, grade-band concept, level-concept bucket, Knowledge Area, competence area). The cross-framework abstract; queries against it reach all eight frameworks. Workforce frameworks where the unit is genuinely a work role or profile (NICE / DCWF / ENISA ECSF) additionally subclass `cybed:Role`.
