...
In `scripts/020-assemble-jsonld.R`, add an assembler function and register it:
...
Existing SPARQL queries automatically include the new framework because they match on `cybed:Framework`, `cybed:Role`, and `cybed:RoleElement`, the framework-agnostic types. No query rewrites required.
