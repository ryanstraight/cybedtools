...
Pick a `framework_subtype` that names what the unit IS in the framework's own terminology rather than coercing it under "WorkRole." See the [namespace-architecture](../articles/namespace-architecture.html) article for the existing per-framework subtype table; new frameworks should follow the same pattern.
